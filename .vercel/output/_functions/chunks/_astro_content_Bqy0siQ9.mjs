...
import { f as renderElement, g as generateCspDigest, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, h as removeBase, b as isRemotePath, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as prependForwardSlash, j as createHeadAndContent, c as renderComponent } from './entrypoint_C17WtrUW.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DGXecT3b.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_CqPWAOnr.mjs');
