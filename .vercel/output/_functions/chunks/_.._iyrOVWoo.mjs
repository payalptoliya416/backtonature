...
async function getStaticPaths() {
  const items = await getCollection("rank_math_schema");
...
}, "P:/Astro/new-migration/output/src/pages/rank_math_schema/[...slug].astro", void 0);

const $$file = "P:/Astro/new-migration/output/src/pages/rank_math_schema/[...slug].astro";
const $$url = "/rank_math_schema/[...slug]";
